...
** LSP mode
This can be used for TS/JS as well if needed
#+begin_src emacs-lisp
...
Tide setup. Use this or lsp mode.
#+begin_src emacs-lisp :tangle no
  (defun setup-tide-mode-javascript ()
    (interactive)
    (tide-setup)
    (eldoc-mode +1)
    (tide-hl-identifier-mode +1))

  (defun setup-tide-mode-typescript ()
    (interactive)
    (tide-setup)
    (eldoc-mode +1)
    (tide-hl-identifier-mode +1))
  ...
  (use-package tide
    ...
    :hook
    (js-mode . setup-tide-mode-javascript)
    (typescript-mode . setup-tide-mode-typescript))
#+end_src
** YAML
#+begin_src emacs-lisp
