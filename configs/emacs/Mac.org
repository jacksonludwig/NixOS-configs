...
(set-face-background 'modus-themes-fringe-cyan (face-background 'default))   ; hide bg in fringe
(set-face-background 'modus-themes-fringe-yellow (face-background 'default)) ; hide bg in fringe
#+end_src
