...
* Font setup
#+begin_src emacs-lisp
(defvar jackson/default-font-size 122)
...
#+end_src
** Evil
This can be activated to use hybrid vim and emacs bindings.
...
#+end_src
** Theme/modeline
Doom-themes does a lot of tweaking to theming. It shouldn't be used unless you're always using themes from the package.
#+begin_src emacs-lisp :tangle no
...
(use-package lsp-ui
  ...
  (general-define-key
   ...
   "M-?" 'lsp-ui-peek-find-references ;; overwrite defaults with UI versions
